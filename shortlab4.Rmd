...
$p-value =2\ min \{ P(X \ge x\ |\ H_0),\  P(X \le x\ |\ H_0) \}$

p-value is the probability of observing a result as or more extreme than the observed result, 
assuming the null hypothesis is true.

**2b.** Write the mathematical definition of type 1 error, then explain it using your own words.

$\alpha=P($reject$H_0\ |\ H_0)$

Type 1 error is to incorrectly reject the null hypothesis when the null hypothesis is true.

**2c.** Write the mathematical definition of type 2 error, then explain it using your own words.

$\beta=P($not reject$H_0\ |\ H_a)$

Type 2 error is incorrectly fail to reject the null hypothesis when the null hypothesis is false.
...
The average height of students at UW is greater than 66 inches.
...
The average height of students at UW is less or equal to 66 inches.
